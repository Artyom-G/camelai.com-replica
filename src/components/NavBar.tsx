    ...
    <nav className="fixed top-2 left-0 right-0 mx-[12px] 
      ...
      <div className="max-w-[1390px] mx-auto flex justify-between items-center px-6 py-2 align-middle">
        ...
        <div className="space-x-6 align-middle">
          <a href="/blog" className="nav-hover transition-colors duration-300 relative pb-1">
            Blog
          </a>
          <a href="/Pricing" className="nav-hover transition-colors duration-300 relative pb-1">
            Pricing
          </a>
          <a href="/login" className="nav-hover transition-colors duration-300 relative pb-1">
            Log In
          </a>
        </div>
      </div>
